...
// (fichier NON versionné). Absent -> on retombe sur les clés debug pour que
// `flutter run --release` fonctionne toujours en local.
...
android {
    ...
    buildTypes {
        release {
            // Utilise le keystore release si key.properties est présent,
            // sinon retombe sur les clés debug (dev local uniquement).
